...
then
  ...
  scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i do_deploy docker-compose-do.yml root@46.101.192.146:/tmp/
  ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i do_deploy root@46.101.192.146 "docker-compose -f /tmp/docker-compose-do.yml restart"
fi
