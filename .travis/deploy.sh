...
then
  ...
  ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i do_deploy root@207.154.246.48 "cd /tmp; docker-compose -f docker-compose-do.yml pull && docker-compose -f docker-compose-do.yml up -d"
fi
