...
describe('pdfGeneration', () => {
  ...
  xit('should automatically download a PDF file called start_numbers', (done) => {
  ...
  describe('generateStartNumbers', () => {
    ...
    xit('should add a checkmark symbol only if the participant has payed', (done) => {
      pdfGeneration.generateStartNumbers(res, documentMock).then( () => {
  ...
  describe('generateCertificate', () => {
    xit('should generate one certificate', (done) => {
